...
import scissors from '../../public/svg/scissors.svg'
            ...
            <div className="flex flex-col justify-between desctop:flex-row">
                <div className="flex flex-col gap-20">
                    ...
                    <div className="flex flex-col-reverse desctop:flex-col gap-20">
                        ...
                        <img src={img1} className="w-[min(570px,90%)] mx-auto rounded-lg shadow-small"/>
                    </div>
                </div>
                <div className="mt-20 flex flex-col justify-between">
                    <img src={img2} className="w-[min(423px,90%)] mx-auto rounded-lg shadow-small"/>
                    <img src={scissors} className="hidden desctop:block"/>
                </div>
            </div>
        </section>
     );
