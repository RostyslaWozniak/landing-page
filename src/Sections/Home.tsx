    ...
    return ( 
        <section id="home" className="flex flex-col pt-24">
            <div className="flex flex-col-reverse justify-between items-center desctop:flex-row">
                ...
                <div 
                className={`h-[600px] w-[min(500px,90%)] flex flex-col justify-between mt-24 rounded-lg bg-[url(/images/home.jpg)] bg-center bg-[length:500px_600px] hover:bg-[length:550px_650px] duration-500 shadow-small`}>
                </div>
                ...
                <div className="h-[600px] w-[min(500px,90%)] flex flex-col justify-between mt-24 rounded-lg">
                    ...
                    <a href="#projects" className="group h-[250px] w-[min(500px,90%)] relative hover:translate-x-[-20px] hover:translate-y-[-20px] duration-500">                        
                        ...
                        />
                        <div className="absolute h-[250px] w-[200px] rounded-lg shadow-small group-hover:shadow-custom brightness-95 group-hover:scale-[120%] duration-500 hover:brightness-105 bg-[url(/images/img-1.jpg)] bg-center bg-[length:200px_250px] hover:bg-[length:250px_300px]" 
                        />
                    </a>
                </div>
